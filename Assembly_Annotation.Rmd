...
###Create a directory called "genomes" with final format and unique ID followed by "_genomic.fna.gz"

###To zip all the .fna files in the directory
cd /genomes
gzip *.fna
...
Output files: **_puls_sums.tsv** and ** _puls.tsv**
...
FastTree _user_msa.fasta > _Genome_Tree.tree
