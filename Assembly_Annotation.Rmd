...
Raw reads of Flavobacteriaceae genomes sequenced in this study were deposited at the the European Nucleotide Archive (ENA) under Study Accession Number __PRJEB35092__.
...
[FASTQC 0.11.4](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/INSTALL.txt) was used to check the quality of the raw reads.
...
###Draft assembly improvement [Pilon 1.22](https://github.com/broadinstitute/pilon/wiki).
