...
For the Hiseq data, best k-mer size was predicted and then assembly with SPAdes followed. 
```{r, eval=FALSE}
##Prediction of best k-mer size using KmerGenie 1.6741
~/kmergenie-1.6741/kmergenie ~/1_2.fastq
